...
const DesdeRedaccion = ({props, cantidad, class_col_bootstrap}) => {
    console.log (props)

    const url = 'https://www.googleapis.com/youtube/v3/playlistItems?key=AIzaSyB5fgzQfbpF-6_HSQ5k2slhlvaXb6-PRdg&channelId=UC64ZNqX0FQHabP8iIkmnR3A&playlistId=PLDedS24i-fT-aGqPBYipaZVCFsYag6isA&part=snippet,id&&order=date&maxResults=12';
